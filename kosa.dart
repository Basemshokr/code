...
class kosa_ana extends StatefulWidget {
  const kosa_ana({super.key});

  @override
  State<kosa_ana> createState() => _kosa_anaState();
}

class _kosa_anaState extends State<kosa_ana> {
  File? _selectedimage;
