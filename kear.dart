...
class kear_ana extends StatefulWidget {
  const kear_ana({super.key});

  @override
  State<kear_ana> createState() => _kear_anaState();
}

class _kear_anaState extends State<kear_ana> {
  File? _selectedimage;
