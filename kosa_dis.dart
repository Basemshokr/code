...
class kosa_dis extends StatefulWidget {
  const kosa_dis({super.key});

  @override
  State<kosa_dis> createState() => _kosa_disState();
}

class _kosa_disState extends State<kosa_dis> {
  File? _selectedimage;
