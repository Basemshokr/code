...
class kear_dis extends StatefulWidget {
  const kear_dis({super.key});

  @override
  State<kear_dis> createState() => _kear_disState();
}

class _kear_disState extends State<kear_dis> {
  File? _selectedimage;
