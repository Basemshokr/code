...
class eng_slider1 extends StatefulWidget {
  const eng_slider1({super.key});

  @override
  State<eng_slider1> createState() => _eng_slider1State();
}

class _eng_slider1State extends State<eng_slider1> {
  final List<PageViewModel> pages = [
    PageViewModel(
      ...
      decoration: const PageDecoration(
        ...
        bodyTextStyle: TextStyle(
            fontSize: 35.0, fontStyle: FontStyle.italic, color: Colors.black),
    ...
    PageViewModel(
      ...
      decoration: const PageDecoration(
        ...
        bodyTextStyle: TextStyle(
            fontSize: 35.0, color: Colors.black, fontStyle: FontStyle.italic),
        imagePadding:
    ...
    return IntroductionScreen(
      ...
      onDone: () {
        ...
        Navigator.of(context).pushReplacement(
          MaterialPageRoute(builder: (context) => eng_app_page()),
        );
      },
      onSkip: () {
